...
namespace servmon
{
    internal class Configuration
    {
        ...
        private const string DefaultServiceName = "servmon";
        private const string DefaultServiceDisplayName = "Monitor service and send notification";
        private const string DefaultServiceDescription = "Monitor service and send notification";
