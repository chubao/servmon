...
namespace servmon
{
    public class QuartzServer : ServiceControl, IQuartzServer
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual ISchedulerFactory CreateSchedulerFactory()
        {
        ...
        public virtual void Start()
        {
            ...
            {
                logger.Fatal(string.Format("Scheduler start failure: {0}", ex.Message), ex);
                throw;
            }
        ...
        public virtual void Stop()
        {
            ...
            {
                logger.Error(string.Format("Scheduler stop failure: {0}", ex.Message), ex);
                throw;
            }
